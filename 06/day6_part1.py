...
print most_used_letter(column1)
print most_used_letter(column2)
print most_used_letter(column3)
print most_used_letter(column4)
print most_used_letter(column5)
print most_used_letter(column6)
print most_used_letter(column7)
print most_used_letter(column8)
